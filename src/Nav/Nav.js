...
const Nav = () => {
    ...
    return (
        <nav >
            ...
            {isOpen && <ul className={` ${isOpen ? s.list + ' active' : s.list} `}>
                <NavLink to='/Home' onClick={closeMenuHandler}><span className={`${s.icon} icon-home`}></span><span className={s.item}>HOME</span></NavLink>
